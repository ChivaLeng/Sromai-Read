package com.example.lengchiva.mybook;
...
public class NewBook extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_top_book) {
            ...
            Toast.makeText(getApplicationContext(), getString(R.string.setting), Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_about_us) {
            Toast.makeText(getApplicationContext(),getString(R.string.about_us),Toast.LENGTH_SHORT).show();
        }
